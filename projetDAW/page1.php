...
<body >
     ...
     <nav id="sidebar" class="sidebar">
		...
		C486.09,414.275,392.712,380.035,359.51,367.614z" />
                    ...
                    <div class="class">
                        <div class="icon">
                            ...
                            <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                            <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">                                  <!--Icons importé de W3.CSS-->
                                <g>
		...
		c-23.216,0-42.016,18.801-42.016,42.016C39.424,98.155,58.224,116.972,81.44,116.972z" />
                                    <path class="st0"
                                        d="M224.166,245.037c0-0.856-0.142-1.673-0.251-2.498l62.748-45.541c3.942-2.867,4.83-8.411,1.963-12.362
		...
		C469.411,456.771,448.804,440.853,424.545,440.853z" />
                ...
                <div class="student">
                    <div class="name">
                        <div class="icon"> 
                            <?xml version="1.0" encoding="utf-8"?>                                                                                  <!--Icons importé de W3.CSS-->
		...
		C469.411,456.771,448.804,440.853,424.545,440.853z" />
                        ...
                        <p>L2 section 1 group 3</p>                                                                                                <!--Icons importé de W3.CSS-->
                    </div>
                    <div class="email">
                        <div class="icon">
                            <?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                        ...
                        <p>m.kameli.prs@gmail.com</p>                                                                                             <!--Icons importé de W3.CSS-->
                    </div>
                </div>
            </div>
        </nav>
            ...
            <div class="articles">
                <div class="article">
                    ...
                    <div class="info">
                        ...
                        <a class="moreInfo" href="/moreInfo/index.html"><big><b>more information</b></big></a>
                    </div>
                </div>
